...
export default function ScorePage() {
  ...
  // Load players and any existing scores
  useEffect(() => {
  ...
  async function saveHole() {
    ...
    await Promise.all(payloads.map(rec => fetch('/api/scores', {
      method: 'POST',
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between bg-white p-3 rounded shadow">
        <button onClick={handlePrev} className="px-3 py-2 bg-gray-200 rounded">Prev</button>
